...
export async function POST(req) {
  ...
  const mailOptionsHooks = {
    ...
    html: `
      ...
      <p>This is an automated message. Please do not reply to this email. Go to <a href="https://uniswaphooks-nzcz2pfzh-findmalek.vercel.app/dashboard" target="_blank">Dashboard</a> to manage your hooks.</p>
    `,
  }
  ...
  const mailOptionsResouces = {
    ...
    html: `
      ...
      <p>This is an automated message. Please do not reply to this email. Go to <a href="https://uniswaphooks-nzcz2pfzh-findmalek.vercel.app/dashboard" target="_blank">Dashboard</a> to manage your resources.</p>
    `,
  }
